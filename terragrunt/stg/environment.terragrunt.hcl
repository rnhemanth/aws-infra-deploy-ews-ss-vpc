locals {
  ...
  ipv4_primary_cidr_block              = "100.76.12.0/22"
  ipv4_secondary_cidr_blocks           = []
  tgw_id_backbone                      = "tgw-0f28603fcaf843cb9"
  tgw_id_hscn                          = "tgw-0fae19691d80648cc"
  peer_vpc_id                          = "vpc-06768ff14dfefa91f"
  peer_region                          = "eu-west-2"
  peer_owner_id                        = "120521801557"
  peering_route_cidr_block             = ""
  england_peer_id                      = ""
  bastion_generic_cidr                 = ["100.76.17.0/28", "100.76.17.16/28"]
  bastion_migration_cidr               = ["100.76.17.32/28", "100.76.17.48/28"]
  shared_service_ad_cidr               = ["100.76.12.176/28", "100.76.14.32/28"]
  wsus_cidr                            = ["100.76.10.112/28", "100.76.10.96/28"]
  england_ad_cidr                      = ["100.76.6.176/28", "100.76.6.192/28"]
  delinea_cidr_block                   = "100.76.8.0/25"
  netbackup_cidr_block                 = "100.76.5.128/25"
  r53_outbound_endpoint_subnet         = "100.88.8.128/26"
  hscn_dns                             = ["155.231.231.1/32", "155.231.231.2/32"]
  peering_route_cidr_block_ss_bastions = "100.76.17.0/25"
  peering_route_sec_cidr_block_ss_bastion = "100.79.2.0/26"
  bastions_peer_id                     = "pcx-098af62d4e3825d28"
  firecracker_cidr_block               = "172.16.0.0/16"
  legacy_cidr_block                    = "44.0.0.0/8"
  onprem_cidr_block                    = "192.168.0.0/16"
  england_app_cidr_block               = ["100.76.6.80/28", "100.76.6.96/28"]
  on_prem_management_servers           = ["44.128.219.100/32", "44.128.211.206/32", "44.128.219.98/32", "44.128.203.206/32", "44.128.203.207/32"]
  awspatchstore_cidr_block             = ["100.76.6.208/28", "100.76.6.224/28"]
  ad_mgmt_security_group               = "sg-08fe5927ce97f08ad"
  exa_sg_cidr                          = "100.76.11.192/26"
  exa_sg_data_mesh_cidr                = "100.76.11.192/26"
  ibi_instances                        = ["100.76.26.75/32", "100.76.26.90/32", "100.76.26.79/32"]
  ...
  intra_subnets = {
    fsx = {
      fsx-2a = {
        cidr_block           = "100.76.15.0/28"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      fsx-2c = {
        cidr_block           = "100.76.15.16/28"
    ...
    sql = {
      sql-2a = {
        cidr_block           = "100.76.13.64/26"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      sql-2b = {
        cidr_block           = "100.76.14.192/26"
    ...
    ss-apps = {
      ss-apps-2a = {
        cidr_block           = "100.76.12.192/26"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      ss-apps-2b = {
        cidr_block           = "100.76.14.64/26"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
    managed-ad = {
      managed-ad-2a = {
        cidr_block           = "100.76.12.176/28"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      managed-ad-2b = {
        cidr_block           = "100.76.14.32/28"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
    nlb-hscn = {
      nlb-hscn-2a = {
        cidr_block           = "100.76.12.128/27"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "yes"
      }
      nlb-hscn-2b = {
        cidr_block           = "100.76.14.0/27"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "yes"
      }
    }
    tgw-vpce = {
      tgw-vpce-2a = {
        cidr_block           = "100.76.12.160/28"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      tgw-vpce-2b = {
        cidr_block           = "100.76.14.48/28"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
      tgw-vpce-2c = {
        cidr_block           = "100.76.12.16/28"
        availability_zone_id = "euw2-az1"
        hscn_connectivity    = "no"
      }
    }
    wsus = {
      wsus-2a = {
        cidr_block           = "100.76.15.32/28"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      wsus-2b = {
        cidr_block           = "100.76.15.48/28"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
    supp-services = {
      supp-services-2a = {
        cidr_block           = "100.76.13.0/26"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      supp-services-2b = {
        cidr_block           = "100.76.14.128/26"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
    ...
    certauth = {
      certauth-2a = {
        cidr_block           = "100.76.15.80/28"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      certauth-2b = {
        cidr_block           = "100.76.15.96/28"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
  ...
  public_subnets = {
    eu-west-2a = {
      cidr_block              = "100.76.12.32/27"
      availability_zone_id    = "euw2-az2"
      map_public_ip_on_launch = "no"
    }
    eu-west-2b = {
      cidr_block              = "100.76.13.160/27"
      availability_zone_id    = "euw2-az3"
      map_public_ip_on_launch = "no"
    }
  }
  ...
  private_subnets = {
    dmz = {
      eu-west-2a = {
        cidr_block           = "100.76.12.64/26"
        availability_zone_id = "euw2-az2"
        hscn_connectivity    = "no"
      }
      eu-west-2b = {
        cidr_block           = "100.76.13.192/26"
        availability_zone_id = "euw2-az3"
        hscn_connectivity    = "no"
      }
    }
  ...
  route53_resolver_rules = {
    ...
    stg_england_emis_web_com = {
      rule_id = "rslvr-rr-108737707547444ba"
    }
    stg_shared_services_emis_web_com = {
      rule_id = "rslvr-rr-889a0ac743564fbe9"
    }
    stg_iom_emis_web_com = {
  ...
  standard_sg_rules_cidr_blocks = {
    ...
    rule46 = { type = "egress", from = 33956, to = 33956, protocol = "tcp", cidr = "${local.england_ad_cidr}", desc = "Allow TCP ldaps to DNS england AD subnet" }
  }
  ...
  db_sg_rules_cidr_blocks = {
    ...
    rule10 = { type = "ingress", from = 1433, to = 1433, protocol = "tcp", cidr = "${local.ibi_instances}", desc = "Allow TCP 1433 from IBI instances" }
  }
  ...
  private_sg_rules_cidr_block = {
    ...
    rule14 = { type = "egress", from = 8085, to = 8085, protocol = "tcp", cidr = ["${local.onprem_cidr_block}", "${local.legacy_cidr_block}", "${local.firecracker_cidr_block}"], desc = "Allow traffic from private CIDR block to 8085 on-prem" }
    rule15 = { type = "egress", from = 8085, to = 8085, protocol = "tcp", cidr = "${local.england_app_cidr_block}", desc = "Allow traffic from private CIDR block to 8085 england app subnets" }
    rule16 = { type = "egress", from = 8530, to = 8531, protocol = "tcp", cidr = "${local.wsus_cidr}", desc = "Allow TCP 8530 - 8531 to WSUS" }
    rule17 = { type = "egress", from = 49152, to = 65535, protocol = "tcp", cidr = ["${local.intra_subnets.managed-ad["managed-ad-2b"].cidr_block}", "${local.intra_subnets.managed-ad["managed-ad-2a"].cidr_block}"], desc = "egress 49152-65535 traffic to AD subnet" }
  ...
  exa_sg_rules_cidr_blocks = {
    ...
    rule5 = { type = "ingress", from = 1433, to = 1433, protocol = "tcp", cidr = ["${local.exa_sg_data_mesh_cidr}"], desc = "Allow TCP 1433 from EXA and EXA Data Mesh" }
  ...
  peering_routes = {
    ...
    england_peer = {
      vpc_cidr   = "100.76.6.0/23"
      peering_id = "pcx-03673b6edf8adaf43"
    }
    nations_core_peer = {
      vpc_cidr   = "100.76.25.0/24"
      peering_id = "pcx-0ec80f9b0c27d3695"
    }
    iom_peer = {
      vpc_cidr   = "100.76.26.0/26"
      peering_id = "pcx-0c7485876a38d72f2"
    }
    exa_peer = {
      vpc_cidr   = "100.76.11.192/26"
      peering_id = "pcx-0a963c6427ab1b142"
    }
  }
